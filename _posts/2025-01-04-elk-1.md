...
이번 포스팅에서는 ELK 스택의 구성 요소와 각 도구의 역할에 대해 살펴보았습니다. 본문에서는 다루지 않았지만, 아래 그림과 같이 RabbitMQ나 Kafka와 같은 메시지 브로커를 함께 활용하면 데이터 중앙화와 흐름 최적화를 더욱 효과적으로 구현할 수 있습니다. ELK 스택 도입은 운영 단계에서 로그 관리를 효율적으로 수행하고, 시스템 모니터링과 에러 대응 속도를 크게 향상시킬 수 있습니다. 읽어 주셔서 감사합니다.

![2025-01-04-elk-08](../assets/img/2025-01-04-elk-1/2025-01-04-elk-08.png)

출처 <https://logz.io/learn/complete-guide-elk-stack/#what-elk-stack>
